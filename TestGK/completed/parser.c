...
/*Bài 1: Mảng Array được xử lý qua hàm compileIndexes(Type *arrayType)
  Bài 2: Thêm Type *compileIfThen(void)
  Bài 3: Sửa hàm compileAssignSt để xử lý gán nhiều giá trị cùng lúc */
void scan(void)
{
